...
Follow this loop: **research → plan → TODO list → execute → review → research again as needed.** Do not stop until every item on the TODO list is verified complete. Do not stop until every item on the TODO list is verified complete. Do not stop until every item on the TODO list is verified complete. (Yes, three times. This mission is the foundation — if it is shallow, every downstream mission will struggle.)
...
**Do not stop until every item on the TODO list is verified complete.**
**Do not stop until every item on the TODO list is verified complete.**
**Do not stop until every item on the TODO list is verified complete.**
