...
13. **[13_MISSION_FE_01_DESIGN_SYSTEM.md](./13_MISSION_FE_01_DESIGN_SYSTEM.md)** — Fetches the design artifact from the designer's URL, extracts tokens, builds every primitive component. Foundation for every surface.
